...
public class aklientGUI implements ActionListener, 
PropertyChangeListener{

	private JFrame frmKwurkonnectV;
	private JTextField usernameField;
	private JTextField passwordVisibleBox;
	private JButton btnKonnect;
	private JPasswordField passwordHiddenField;
	private String[] statuses;
	private String consoleOutPt;
	private Task task;
	private JProgressBar progressBar;
	private JTextArea console;
	private klient klientConnect;
	private JCheckBox chckbxLaunchKreditTracker;
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					aklientGUI window = new aklientGUI();
					window.frmKwurkonnectV.setVisible(true);
				} catch (Exception e) {
					e.printStackTrace();
				}
			}
	...
	private void initialize() {
		...
		final JButton btnKonnect = new JButton("Konnect");
    ...
    public void propertyChange(PropertyChangeEvent evt) {
        if ("progress" == evt.getPropertyName()) {
            int progress = klientConnect.getStatus();
            progressBar.setValue(progress);
            console.append(String.format(
            		statuses[klientConnect.getStatus()], task.getProgress()));
        } 
    }
